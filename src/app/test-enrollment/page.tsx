...
const sampleCourse: CourseWithDetails = {
  ...
  description: "كورس شامل لتعلم تلاوة وحفظ القرآن الكريم مع أحكام التجويد الأساسية",
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-center mb-8">اختبار نظام التسجيل</h1>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div>
              <span className="font-medium">المدرس:</span> {sampleCourse.instructor_name}
            </div>
            <div>
              <span className="font-medium">السعر:</span> {sampleCourse.price} ج.م
            </div>
            <div>
              <span className="font-medium">المدة:</span> {sampleCourse.duration}
            </div>
            <div>
              <span className="font-medium">الأماكن المتبقية:</span> {sampleCourse.capacity - sampleCourse.enrolled_count}
            </div>
          </div>
