      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          ...
          <div className="flex justify-between py-3 border-b border-border">
            ...
            <span className="font-medium text-text">{course.num_lectures} محاضرة</span>
          </div>
          
          <div className="flex justify-between py-3 border-b border-border">
            <span className="text-text-muted">تاريخ البداية:</span>
            <span className="font-medium text-text">{formatDate(course.start_date)}</span>
          </div>
          
          <div className="flex justify-between py-3 border-b border-border">
            <span className="text-text-muted">تاريخ النهاية:</span>
            <span className="font-medium text-text">{formatDate(course.end_date)}</span>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <div className="flex justify-between py-3 border-b border-border">
            ...
            <span className="font-medium text-text">{course.capacity} طالب</span>
          </div>
          
          <div className="flex justify-between py-3 border-b border-border">
            <span className="text-text-muted">المسجلون حالياً:</span>
            <span className="font-medium text-text">{course.enrolled_count} طالب</span>
          </div>
